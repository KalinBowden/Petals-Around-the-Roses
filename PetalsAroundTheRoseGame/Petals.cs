...
{
    /// <summary>
    /// Solution: A fun game of Petals around the roses.
    /// Deveoper: Kalin Bowden.
    /// Date Created: 08/24/2016.
    /// Date Last Modified: 08/25/2016.
    /// Purpose: To allow the user to play Petals around the Roses and
    ///   keep track of thier current score and best run.
    /// Note: Uses Randon number class.
    /// </summary>
